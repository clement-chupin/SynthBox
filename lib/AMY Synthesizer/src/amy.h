...
// GrvEP: 128 halves audio latency (~3ms/block vs ~6ms) with multicore rendering on ESP32-S3
#ifdef AMY_DAISY
...
extern int8_t * pcm_load8(uint16_t preset_number, uint32_t length, uint32_t samplerate, uint8_t channels, uint8_t midinote, uint32_t loopstart, uint32_t loopend);
extern void pcm_register_extern8(uint16_t preset_number, const int8_t* data, uint32_t length, uint32_t samplerate, uint8_t midinote, uint32_t loopstart, uint32_t loopend);
extern void pcm_register_extern16(uint16_t preset_number, const int16_t* data, uint32_t length, uint32_t samplerate, uint8_t midinote, uint32_t loopstart, uint32_t loopend);
